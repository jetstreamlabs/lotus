...
use Serenity\Lotus\Console\RepositoryContractMakeCommand;
...
class ArtisanExtendProvider extends ServiceProvider
{
    ...
    protected $devCommands = [
        ...
        'RepositoryContractMake' => 'command.repository.contract.make',
     ...
     * @return void
     */
    protected function registerRepositoryContractMakeCommand()
    {
        $this->app->singleton('command.repository.contract.make', function ($app) {
            return new RepositoryContractMakeCommand($app['files']);
        });
    }
